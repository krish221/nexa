...
public class MMPScheduleAppointment
{
    ...
    public void navigateToSubMenu(String subMenuText) {
        ...
        driver.findElement(By.xpath("//ul/li[@class='submenu']/a/span[contains(text(),'" + subMenuText + "')]"))
                .click();
    }
    ...
    public void bookAppointment(String doctorName, String date, String time, String sym) {
        ...
        driver.findElement(By.xpath("//table[@class='table']//h4[text()='Dr." + doctorName + "']/ancestor::td/button"))
                .click();
